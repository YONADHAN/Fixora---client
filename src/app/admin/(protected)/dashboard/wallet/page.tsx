...
import { useAdminWallet } from '@/lib/hooks/useWallet'
...
export default function AdminWalletPage() {
  ...
  const { data, isLoading, error } = useAdminWallet({
    page,
    limit: 4,
    sortBy,
    order,
  ...
  if (error)
    return (
      <div className='p-6 text-center text-gray-500 dark:text-red-400'>
  ...
  return (
    <div className='max-w-3xl mx-auto p-6 space-y-6'>
      ...
      <div className='border rounded-lg p-4 bg-white dark:bg-slate-900 dark:border-gray-800 shadow-sm'>
        ...
        <h1 className='text-3xl font-bold mt-1 text-slate-800 dark:text-white'>
          ₹{data.wallet.balance}
        </h1>
        <p className='text-xs text-gray-500 dark:text-gray-500 mt-1 uppercase'>
