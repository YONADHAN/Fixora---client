...
const CustomerProfilePage = () => {
  ...
  if (isLoading)
    return (
      <div className='min-h-screen flex items-center justify-center text-gray-500 dark:text-gray-400 dark:bg-gray-950'>
        Loading profile...
      </div>
    )
  ...
  if (isError)
    return (
      <div className='min-h-screen flex items-center justify-center text-red-500 dark:bg-gray-950'>
