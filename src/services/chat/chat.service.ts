...
export const chatService = {
    ...
    async getChatMessages(role: Role, chatId: string, page = 1, limit = 20) {
        ...
        // Note: The routes constants might differ in structure (with or without parameters placeholder)
        // Assuming typical structure: /chat or /chat/:id/messages
        // If the constant includes the placeholder, we might need to handle it differently.
        // Based on existing code: `${CUSTOMER_ROUTES.GET_CHAT_MESSAGES}/${chatId}/messages`
